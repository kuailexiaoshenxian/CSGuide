...
在这里我想分享一下 Linux C/C++ 后台服务器开发学习之路该怎么去学习，我曾经在校招中拿到了 BAT 等公司的 SP、SSP offer，目前在微信做 C++ 后台开发，在学习路线和学习方法上有一定心得分享给大家。
看完本文你将会对以下问题有所了解：
...
# Linux C++ 服务器端这条线怎么走？一年能做出什么？
## 一年足够入门拿Offer！
之前在校的时候，大二之前其实一直都在学习 Java 方向包括 SSM 那一套，后来大二下喜欢上了偏底层的一些东西，于是转 Linux C++，**后来通过一年的时间学习，我顺利在大三实习生招聘中顺利通过微信、网易、阿里、字节等实习生招聘技术面试，最后选择去了微信实习。**
...
**那 Linux C/C++ 服务器/后台开发指的什么呢，其实就是基于 Linux 上 的 C++ 后台编程。**
...
## 10.2 视频推荐
视频可以看看 ：
* mooc 上浙大的《数据结构》：[https://www.icourse163.org/course/ZJU-93001](https://www.icourse163.org/course/ZJU-93001)
